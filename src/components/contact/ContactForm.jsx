    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          >
            ...
            <option value="web-development" className="bg-dark-100">
              Web Development
            </option>
            <option value="mobile-development" className="bg-dark-100">
              Mobile Development
            </option>
            <option value="ui-ux-design" className="bg-dark-100">
              UI/UX Design
            </option>
            <option value="digital-marketing" className="bg-dark-100">
              Digital Marketing
            </option>
            <option value="consultation" className="bg-dark-100">
              Konsultasi
            </option>
            <option value="other" className="bg-dark-100">
              Lainnya
            </option>
          </select>
        </div>
      ...
      {submitStatus === "success" && (
        <div className="p-4 bg-primary/20 text-primary rounded-lg border border-primary/30">
          Terima kasih! Pesan Anda telah terkirim. Kami akan segera menghubungi
          Anda.
        </div>
      )}
