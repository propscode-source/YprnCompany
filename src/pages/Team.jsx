        ...
        <div className="container-custom relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="heading-primary mt-2 mb-6">
              Kenali <span className="gradient-text">Tim Hebat</span> di Balik
              Kesuksesan
            </h1>
            <p className="text-body">
              Tim profesional kami terdiri dari individu-individu berbakat yang
              berdedikasi untuk memberikan hasil terbaik bagi setiap klien.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            {teamStats.map((stat, index) => {
              ...
              return (
                <div
                  key={index}
                  className="card-glow p-6 text-center hover:border-primary/50 transition-all duration-300"
                >
                  <IconComponent
                    className={`mx-auto mb-3 ${index % 2 === 0 ? "text-primary" : "text-secondary"}`}
                    size={32}
                  />
                  <p
      ...
      <section className="section-padding bg-dark-50">
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="heading-secondary">Leadership Team</h2>
            <p className="text-body mt-4">
              Para pemimpin visioner yang mengarahkan perusahaan menuju
              kesuksesan.
            </p>
          </div>
          <TeamGrid />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-body mb-6">
                Kami selalu mencari talenta-talenta terbaik untuk bergabung
                dengan tim kami. Jika Anda memiliki passion di bidang teknologi
                dan ingin berkembang bersama, kami ingin mendengar dari Anda.
              </p>
